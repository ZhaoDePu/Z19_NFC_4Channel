...
--               D:/Xilinx_2019_2/RTL_prj/OCOWFC_Z19/OCOWFC_Z19/Z19_NFC_4Chanel/Z19_NFC_4Channel/Z19_NFC_4Channel.srcs/sources_1/bd/NFC_4Channel_bd/ip/NFC_4Channel_bd_clk_wiz_0_0/NFC_4Channel_bd_clk_wiz_0_0_sim_netlist.vhdl
...
entity NFC_4Channel_bd_clk_wiz_0_0_NFC_4Channel_bd_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of NFC_4Channel_bd_clk_wiz_0_0_NFC_4Channel_bd_clk_wiz_0_0_clk_wiz : entity is "NFC_4Channel_bd_clk_wiz_0_0_clk_wiz";
end NFC_4Channel_bd_clk_wiz_0_0_NFC_4Channel_bd_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of NFC_4Channel_bd_clk_wiz_0_0_NFC_4Channel_bd_clk_wiz_0_0_clk_wiz is
  signal clk_ctrl_50_NFC_4Channel_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_NFC_4Channel_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_ref_NFC_4Channel_bd_clk_wiz_0_0 : STD_LOGIC;
  signal nand_clk_fast_NFC_4Channel_bd_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_NFC_4Channel_bd_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => nand_clk_fast_NFC_4Channel_bd_clk_wiz_0_0,
      O => nand_clk_fast
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_ref_NFC_4Channel_bd_clk_wiz_0_0,
      O => clk_ref
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_ctrl_50_NFC_4Channel_bd_clk_wiz_0_0,
      O => clk_ctrl_50
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_NFC_4Channel_bd_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => nand_clk_fast_NFC_4Channel_bd_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_ref_NFC_4Channel_bd_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_ctrl_50_NFC_4Channel_bd_clk_wiz_0_0,
...
entity NFC_4Channel_bd_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of NFC_4Channel_bd_clk_wiz_0_0 : entity is true;
end NFC_4Channel_bd_clk_wiz_0_0;

architecture STRUCTURE of NFC_4Channel_bd_clk_wiz_0_0 is
begin
inst: entity work.NFC_4Channel_bd_clk_wiz_0_0_NFC_4Channel_bd_clk_wiz_0_0_clk_wiz
     port map (
      clk_ctrl_50 => clk_ctrl_50,
      clk_in1 => clk_in1,
      clk_ref => clk_ref,
      locked => locked,
