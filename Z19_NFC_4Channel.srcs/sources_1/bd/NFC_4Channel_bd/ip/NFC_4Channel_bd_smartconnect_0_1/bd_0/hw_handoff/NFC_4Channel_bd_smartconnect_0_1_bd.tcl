...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M03_S06_CONNECTIVITY {1} \
   CONFIG.M03_S07_CONNECTIVITY {1} \
   CONFIG.M03_S08_CONNECTIVITY {1} \
...
proc create_hier_cell_s08_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG001_BASE_ADDR {0x00000000A2000000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x00000000A4000000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x00000000A6000000} \
...
proc create_hier_cell_m03_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC001_ROUTE {0b000000000} \
