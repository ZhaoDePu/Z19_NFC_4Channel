...
################################################################
# This is a generated script based on design: bd_4414
#
...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M03_S06_CONNECTIVITY {0} \
   CONFIG.M03_S07_CONNECTIVITY {0} \
   CONFIG.M03_S08_CONNECTIVITY {0} \
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG001_BASE_ADDR {0x0000000082000000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000084000000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000086000000} \
...
proc create_hier_cell_m03_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {32} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b000000000} \
   CONFIG.SSC001_ROUTE {0b000000001} \
   CONFIG.SSC002_ROUTE {0b000000010} \
   CONFIG.SSC003_ROUTE {0b000000100} \
   CONFIG.SSC004_ROUTE {0b000001000} \
   CONFIG.SSC005_ROUTE {0b000010000} \
   CONFIG.SSC006_ROUTE {0b000100000} \
   CONFIG.SSC007_ROUTE {0b001000000} \
   CONFIG.SSC008_ROUTE {0b010000000} \
   CONFIG.SSC009_ROUTE {0b100000000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins M01_ARESETN] [get_bd_pins M02_ARESETN] [get_bd_pins M03_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins S08_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:M02_AXI:M03_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI:S07_AXI:S08_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AW_7 [get_bd_intf_pins m01_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M01_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins m02_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M02_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_9 [get_bd_intf_pins m03_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M03_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_7 [get_bd_intf_pins m01_nodes/S_SC_B] [get_bd_intf_pins m01_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins m02_nodes/S_SC_B] [get_bd_intf_pins m02_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_9 [get_bd_intf_pins m03_nodes/S_SC_B] [get_bd_intf_pins m03_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_W_7 [get_bd_intf_pins m01_nodes/S_SC_W] [get_bd_intf_pins switchboards/M01_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins m02_nodes/S_SC_W] [get_bd_intf_pins switchboards/M02_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_9 [get_bd_intf_pins m03_nodes/S_SC_W] [get_bd_intf_pins switchboards/M03_SC_W]
