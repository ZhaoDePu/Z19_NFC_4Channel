...
################################################################
# This is a generated script based on design: bd_84d5
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000080010000} \
   ...
   CONFIG.SEG001_BASE_ADDR {0x0000000080020000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000080030000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000080040000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x0000000090000000} \
