...
if(rst) begin
	is_nvddr2 <= 1'h0;                                                                                            
end else if(i_cmd_valid & o_cmd_ready & (i_cmd[7:0]==8'hEF) & (i_addr[7:0] == 8'h01) & (i_data[5:4]==2'h2)) begin
    is_nvddr2 <= 1'h1;  // Timing Mode feature: interface=NV-DDR2 (bit[5:4]=10)
end else if(i_cmd_valid & o_cmd_ready & (i_cmd[7:0]==8'hEF) & (i_addr[7:0] == 8'h01)) begin
    is_nvddr2 <= 1'h0;  // Timing Mode feature: interface=SDR (bit[5:4]!=10)
end
...
if(rst) begin
    ...
    o0_addr      <= 48'h0;                              
    o0_cmd_param <= 32'h0;                              
end else if(i_cmd_valid & o_cmd_ready & (i_cmd[7:0]==8'h70)) begin
    o0_cmd_valid <= 1'h1;
    o0_cmd       <= i_cmd;
    o0_cmd_id    <= i_cmd_id;
    o0_addr      <= i_addr;
    o0_cmd_param <= 32'h0;
end else if(i_cmd_valid & o_cmd_ready & (i_cmd[7:0]==8'h78)) begin
    o0_cmd_valid <= 1'h1;  
    o0_cmd       <= i_cmd;  
    o0_cmd_id    <= i_cmd_id;                                                                
    o0_addr      <= i_addr; // LBA to Flash Address                             
...
//        end
    ...
    o1_addr      <= o_epage_addr; // LBA to Flash Address 
...
if(rst) begin
    ...
    o2_addr      <= o_rpage_addr; // LBA to Flash Address
...
if(rst) begin
    ...
    case(i_cmd[7:0])
        8'hEF: begin  //Set Feature
            ...
            o3_cmd_param <= {16'h8008, t_feature, 3'h1, 1'h0};
        end
        8'hE2: begin  //ODT Configure
            o3_cmd_valid <= is_nvddr2;                                                                  
            o3_cmd       <= i_cmd;   
            ...
            o3_addr      <= i_addr; 
            o3_data      <= { {2{i_data[31:24]}}, {2{i_data[23:16]}}, {2{i_data[15:8]}}, {2{i_data[7:0]}} };       
            o3_cmd_param <= {16'h8008, t_odt, 3'h1, 1'h0};
        end
    endcase
    ...
    o3_addr      <= o_wpage_addr; // LBA to Flash Address 
